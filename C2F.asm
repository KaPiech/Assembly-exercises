//Cwiczenie 5.4    Kamil Gierlach	 Karol Piech		
.org 0x00
ldi R16, high(ramend)
out SPH, R16
ldi R16, low(ramend)
...
prog_start:
	...
	ldi r20, 0x60 ; Lower byte of first number
	ldi r21, 0x00 ; Higher byte of first number

	ldi r22, 0b00000001 ; Lower byte of second number
	ldi r23, 0b00000000 ; Higher byte of second number

	ldi r24, 0x01 ; 16-bit "one" used in
	ldi r25, 0x00 ; abs the result
